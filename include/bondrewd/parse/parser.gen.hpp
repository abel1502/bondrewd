...
protected:
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        (void)_state;
        { // cartridge
            auto _user_opt_cartridge_var = parse_cartridge_rule();
            if (_user_opt_cartridge_var) { auto cartridge_var = std::move(_user_opt_cartridge_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // cartridge_header stmt*
            ...
            if (_user_opt_h) { auto h = std::move(_user_opt_h.value());
            auto _user_opt_b = parse__loop0_1_rule();
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::cartridge>( ast::Cartridge ( std::move ( h ) , std::move ( b ) ));
                return _res;
            }
            }
            seek(_state);
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'cartridge' name ';'
            ...
            if (_user_opt_n) { auto n = std::move(_user_opt_n.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        (void)_state;
        { // var_def_stmt
            auto _user_opt_var_def_stmt_var = parse_var_def_stmt_rule();
            if (_user_opt_var_def_stmt_var) { auto var_def_stmt_var = std::move(_user_opt_var_def_stmt_var.value());
        ...
        { // impl_stmt
            auto _user_opt_impl_stmt_var = parse_impl_stmt_rule();
            if (_user_opt_impl_stmt_var) { auto impl_stmt_var = std::move(_user_opt_impl_stmt_var.value());
        ...
        { // assign_stmt
            auto _user_opt_assign_stmt_var = parse_assign_stmt_rule();
            if (_user_opt_assign_stmt_var) { auto assign_stmt_var = std::move(_user_opt_assign_stmt_var.value());
        ...
        { // expr_stmt
            auto _user_opt_expr_stmt_var = parse_expr_stmt_rule();
            if (_user_opt_expr_stmt_var) { auto expr_stmt_var = std::move(_user_opt_expr_stmt_var.value());
        ...
        { // ';'
            auto _literal = lexer.expect().punct(lex::Punct::SEMI);
            if (_literal) {
                _res = ast::make_field<ast::stmt>( ast::Pass ( ));
                return _res;
            }
            seek(_state);
        }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // expr assign_op expr ';'
            ...
            if (_user_opt_a) { auto a = std::move(_user_opt_a.value());
            auto _user_opt_op = parse_assign_op_rule();
            if (_user_opt_op) { auto op = std::move(_user_opt_op.value());
            auto _user_opt_b = parse_expr_rule();
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
            auto _literal = lexer.expect().punct(lex::Punct::SEMI);
            if (_literal) {
                _res = ast::make_field<ast::stmt>( ast::Assign ( std::move ( a ) , std::move ( b ) , std::move ( op ) ));
                return _res;
            }
            }
            }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // '='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnNone ( ));
                return _res;
            }
            seek(_state);
        }
        { // '+='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnAdd ( ));
                return _res;
            }
            seek(_state);
        }
        { // '-='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnSub ( ));
                return _res;
            }
            seek(_state);
        }
        { // '*='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnMul ( ));
                return _res;
            }
            seek(_state);
        }
        { // '/='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnDiv ( ));
                return _res;
            }
            seek(_state);
        }
        { // '%='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnMod ( ));
                return _res;
            }
            seek(_state);
        }
        { // '<<='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnLShift ( ));
                return _res;
            }
            seek(_state);
        }
        { // '>>='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnRShift ( ));
                return _res;
            }
            seek(_state);
        }
        { // '&='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnBitAnd ( ));
                return _res;
            }
            seek(_state);
        }
        { // '|='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnBitOr ( ));
                return _res;
            }
            seek(_state);
        }
        { // '^='
            ...
            if (_literal) {
                _res = ast::make_field<ast::assign_op>( ast::AsgnBitXor ( ));
                return _res;
            }
            seek(_state);
        }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'ctime'? 'var' name type_annotation? ['=' expr] ';'
            ...
            auto _literal = lexer.expect().punct(lex::Punct::SEMI);
            if (_literal) {
                _res = ast::make_field<ast::stmt>( ast::VarDef ( std::move ( n ) , std::move ( t ) , std::move ( v ) , true , bool ( c ) ));
                return _res;
            }
            }
            }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // expr ';'
            ...
            auto _literal = lexer.expect().punct(lex::Punct::SEMI);
            if (_literal) {
                _res = ast::make_field<ast::stmt>( ast::Expr ( std::move ( a ) ));
                return _res;
            }
            }
            seek(_state);
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        (void)_state;
        { // func_def
            auto _user_opt_func_def_var = parse_func_def_rule();
            if (_user_opt_func_def_var) { auto func_def_var = std::move(_user_opt_func_def_var.value());
        ...
        { // class_def
            auto _user_opt_class_def_var = parse_class_def_rule();
            if (_user_opt_class_def_var) { auto class_def_var = std::move(_user_opt_class_def_var.value());
        ...
        { // block_expr
            auto _user_opt_block_expr_var = parse_block_expr_rule();
            if (_user_opt_block_expr_var) { auto block_expr_var = std::move(_user_opt_block_expr_var.value());
        ...
        { // 'return' expr_or_unit
            ...
            if (_user_opt_a) { auto a = std::move(_user_opt_a.value());
                _res = ast::make_field<ast::expr>( ast::Return ( std::move ( a ) ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // 'break' expr_or_unit
            ...
            auto _user_opt_a = parse_expr_or_unit_rule();
            if (_user_opt_a) { auto a = std::move(_user_opt_a.value());
                _res = ast::make_field<ast::expr>( ast::Break ( std::move ( a ) ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // disjunction_expr
            auto _user_opt_disjunction_expr_var = parse_disjunction_expr_rule();
            if (_user_opt_disjunction_expr_var) { auto disjunction_expr_var = std::move(_user_opt_disjunction_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // expr
            ...
            if (_user_opt_expr_var) { auto expr_var = std::move(_user_opt_expr_var.value());
        ...
        { // 
                _res = ast::make_field<ast::expr>( ast::Constant ( std::monostate ( ) ));
                return _res;
            seek(_state);
        }
        return std::nullopt;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // conjunction_expr (('or' conjunction_expr))+
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BoolOp ( ast::Or ( ) , ... ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // conjunction_expr
            auto _user_opt_conjunction_expr_var = parse_conjunction_expr_rule();
            if (_user_opt_conjunction_expr_var) { auto conjunction_expr_var = std::move(_user_opt_conjunction_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // inversion_expr (('and' inversion_expr))+
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BoolOp ( ast::And ( ) , ... ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // inversion_expr
            auto _user_opt_inversion_expr_var = parse_inversion_expr_rule();
            if (_user_opt_inversion_expr_var) { auto inversion_expr_var = std::move(_user_opt_inversion_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'not' inversion_expr
            ...
            auto _user_opt_a = parse_inversion_expr_rule();
            if (_user_opt_a) { auto a = std::move(_user_opt_a.value());
                _res = ast::make_field<ast::expr>( ast::UnOp ( ast::Not ( ) , std::move ( a ) ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // comparison_expr
            auto _user_opt_comparison_expr_var = parse_comparison_expr_rule();
            if (_user_opt_comparison_expr_var) { auto comparison_expr_var = std::move(_user_opt_comparison_expr_var.value());
                // !!! DBG: BAD ACTION: Alt([NamedItem(None, NameLeaf('comparison_expr'))]) (rule: Rule('inversion_expr', 'ast::field<ast::expr>', Rhs([Alt([NamedItem(None, StringLeaf("'not'")), NamedItem('a', NameLeaf('inversion_expr'))], action='_field_ ast::UnOp ( ast::Not ( ) , std::move ( a ) )'), Alt([NamedItem(None, NameLeaf('comparison_expr'))])])))
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // bidir_cmp_expr comparison_followup_pair+
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::Compare ( std::move ( a ) , ast::make_sequence ( ... ) , ast::make_sequence ( ... ) ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // bidir_cmp_expr
            auto _user_opt_bidir_cmp_expr_var = parse_bidir_cmp_expr_rule();
            if (_user_opt_bidir_cmp_expr_var) { auto bidir_cmp_expr_var = std::move(_user_opt_bidir_cmp_expr_var.value());
                // !!! DBG: BAD ACTION: Alt([NamedItem(None, NameLeaf('bidir_cmp_expr'))]) (rule: Rule('comparison_expr', 'ast::field<ast::expr>', Rhs([Alt([NamedItem('a', NameLeaf('bidir_cmp_expr')), NamedItem('b', Repeat1(NameLeaf('comparison_followup_pair')))], action='_field_ ast::Compare ( std::move ( a ) , ast::make_sequence ( ... ) , ast::make_sequence ( ... ) )'), Alt([NamedItem(None, NameLeaf('bidir_cmp_expr'))])])))
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // comparison_op bidir_cmp_expr
            ...
            if (_user_opt_o) { auto o = std::move(_user_opt_o.value());
            auto _user_opt_a = parse_bidir_cmp_expr_rule();
            if (_user_opt_a) { auto a = std::move(_user_opt_a.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // '=='
            ...
            if (_literal) {
                _res = ast::make_field<ast::cmp_op>( ast::Eq ( ));
                return _res;
            }
            seek(_state);
        }
        { // '!='
            ...
            if (_literal) {
                _res = ast::make_field<ast::cmp_op>( ast::NotEq ( ));
                return _res;
            }
            seek(_state);
        }
        { // '<'
            ...
            if (_literal) {
                _res = ast::make_field<ast::cmp_op>( ast::Lt ( ));
                return _res;
            }
            seek(_state);
        }
        { // '<='
            ...
            if (_literal) {
                _res = ast::make_field<ast::cmp_op>( ast::LtE ( ));
                return _res;
            }
            seek(_state);
        }
        { // '>'
            ...
            if (_literal) {
                _res = ast::make_field<ast::cmp_op>( ast::Gt ( ));
                return _res;
            }
            seek(_state);
        }
        { // '>='
            ...
            if (_literal) {
                _res = ast::make_field<ast::cmp_op>( ast::GtE ( ));
                return _res;
            }
            seek(_state);
        }
        { // 'in'
            ...
            if (_keyword) {
                _res = ast::make_field<ast::cmp_op>( ast::In ( ));
                return _res;
            }
            seek(_state);
        }
        { // 'not' 'in'
            ...
            if (_keyword_1) {
                _res = ast::make_field<ast::cmp_op>( ast::NotIn ( ));
                return _res;
            }
            }
            seek(_state);
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // bitor_expr '<=>' bitor_expr
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::Compare ( std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // bitor_expr
            auto _user_opt_bitor_expr_var = parse_bitor_expr_rule();
            if (_user_opt_bitor_expr_var) { auto bitor_expr_var = std::move(_user_opt_bitor_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // bitor_expr '|' bitxor_expr
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::BitOr ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // bitxor_expr
            auto _user_opt_bitxor_expr_var = parse_bitxor_expr_rule();
            if (_user_opt_bitxor_expr_var) { auto bitxor_expr_var = std::move(_user_opt_bitxor_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // bitxor_expr '^' bitand_expr
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::BitXor ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // bitand_expr
            auto _user_opt_bitand_expr_var = parse_bitand_expr_rule();
            if (_user_opt_bitand_expr_var) { auto bitand_expr_var = std::move(_user_opt_bitand_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // bitand_expr '&' shift_expr
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::BitAnd ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // shift_expr
            auto _user_opt_shift_expr_var = parse_shift_expr_rule();
            if (_user_opt_shift_expr_var) { auto shift_expr_var = std::move(_user_opt_shift_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // shift_expr '<<' sum_expr
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::LShift ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // shift_expr '>>' sum_expr
            ...
            auto _user_opt_b = parse_sum_expr_rule();
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::RShift ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // sum_expr
            auto _user_opt_sum_expr_var = parse_sum_expr_rule();
            if (_user_opt_sum_expr_var) { auto sum_expr_var = std::move(_user_opt_sum_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // sum_expr '+' term_expr
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::Add ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // sum_expr '-' term_expr
            ...
            auto _user_opt_b = parse_term_expr_rule();
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::Sub ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // term_expr
            auto _user_opt_term_expr_var = parse_term_expr_rule();
            if (_user_opt_term_expr_var) { auto term_expr_var = std::move(_user_opt_term_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // term_expr '*' factor_expr
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::Mul ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // term_expr '/' factor_expr
            ...
            auto _user_opt_b = parse_factor_expr_rule();
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::Div ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // term_expr '%' factor_expr
            ...
            auto _user_opt_b = parse_factor_expr_rule();
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::Mod ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // factor_expr
            auto _user_opt_factor_expr_var = parse_factor_expr_rule();
            if (_user_opt_factor_expr_var) { auto factor_expr_var = std::move(_user_opt_factor_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // '+' factor_expr
            ...
            if (_user_opt_a) { auto a = std::move(_user_opt_a.value());
                _res = ast::make_field<ast::expr>( ast::UnOp ( ast::UAdd ( ) , std::move ( a ) ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // '-' factor_expr
            ...
            auto _user_opt_a = parse_factor_expr_rule();
            if (_user_opt_a) { auto a = std::move(_user_opt_a.value());
                _res = ast::make_field<ast::expr>( ast::UnOp ( ast::USub ( ) , std::move ( a ) ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // '~' factor_expr
            ...
            auto _user_opt_a = parse_factor_expr_rule();
            if (_user_opt_a) { auto a = std::move(_user_opt_a.value());
                _res = ast::make_field<ast::expr>( ast::UnOp ( ast::BitInv ( ) , std::move ( a ) ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // power_expr
            auto _user_opt_power_expr_var = parse_power_expr_rule();
            if (_user_opt_power_expr_var) { auto power_expr_var = std::move(_user_opt_power_expr_var.value());
                // !!! DBG: BAD ACTION: Alt([NamedItem(None, NameLeaf('power_expr'))]) (rule: Rule('factor_expr', 'ast::field<ast::expr>', Rhs([Alt([NamedItem(None, StringLeaf("'+'")), NamedItem('a', NameLeaf('factor_expr'))], action='_field_ ast::UnOp ( ast::UAdd ( ) , std::move ( a ) )'), Alt([NamedItem(None, StringLeaf("'-'")), NamedItem('a', NameLeaf('factor_expr'))], action='_field_ ast::UnOp ( ast::USub ( ) , std::move ( a ) )'), Alt([NamedItem(None, StringLeaf("'~'")), NamedItem('a', NameLeaf('factor_expr'))], action='_field_ ast::UnOp ( ast::BitInv ( ) , std::move ( a ) )'), Alt([NamedItem(None, NameLeaf('power_expr'))])])))
                _res = power_expr_var;
                return _res;
            }
            seek(_state);
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // primary_expr '**' factor_expr
            ...
            auto _user_opt_b = parse_factor_expr_rule();
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::BinOp ( ast::Pow ( ) , std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // primary_expr
            auto _user_opt_primary_expr_var = parse_primary_expr_rule();
            if (_user_opt_primary_expr_var) { auto primary_expr_var = std::move(_user_opt_primary_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // primary_expr '.' name
            ...
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::Attribute ( std::move ( a ) , std::move ( b ) , ast::AttrInst ( ) ));
                return _res;
            }
            }
            }
        ...
        { // primary_expr '::' name
            ...
            auto _user_opt_b = parse_name_rule();
            if (_user_opt_b) { auto b = std::move(_user_opt_b.value());
                _res = ast::make_field<ast::expr>( ast::Attribute ( std::move ( a ) , std::move ( b ) , ast::AttrStatic ( ) ));
                return _res;
            }
            }
            }
        ...
        { // primary_expr '[' call_args ']'
            ...
            if (_literal_1) {
                _res = ast::make_field<ast::expr>( ast::Subscript ( std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // primary_expr '(' call_args ')'
            ...
            if (_literal_1) {
                _res = ast::make_field<ast::expr>( ast::Call ( std::move ( a ) , std::move ( b ) ));
                return _res;
            }
            }
            }
        ...
        { // atom_expr
            auto _user_opt_atom_expr_var = parse_atom_expr_rule();
            if (_user_opt_atom_expr_var) { auto atom_expr_var = std::move(_user_opt_atom_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // name
            ...
            if (_user_opt_a) { auto a = std::move(_user_opt_a.value());
                _res = ast::make_field<ast::expr>( ast::Name ( std::move ( a ) ));
                return _res;
            }
            seek(_state);
        }
        { // NUMBER
            ...
            if (_user_opt_a) { auto a = *_user_opt_a;
                _res = ast::make_field<ast::expr>( ast::Constant ( a . get_number ( ) . value ));
                return _res;
            }
            seek(_state);
        }
        { // &STRING strings
            ...
            if (_user_opt_a) { auto a = std::move(_user_opt_a.value());
                _res = ast::make_field<ast::expr>( std::move ( a ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // group_expr
            auto _user_opt_group_expr_var = parse_group_expr_rule();
            if (_user_opt_group_expr_var) { auto group_expr_var = std::move(_user_opt_group_expr_var.value());
        ...
        { // tuple_expr
            auto _user_opt_tuple_expr_var = parse_tuple_expr_rule();
            if (_user_opt_tuple_expr_var) { auto tuple_expr_var = std::move(_user_opt_tuple_expr_var.value());
        ...
        { // array_expr
            auto _user_opt_array_expr_var = parse_array_expr_rule();
            if (_user_opt_array_expr_var) { auto array_expr_var = std::move(_user_opt_array_expr_var.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        (void)_state;
        { // 
                _res = ast::make_field<ast::call_args>( ast::call_args ( ast::make_sequence ( ) , nullptr , nullptr ));
                return _res;
            seek(_state);
        }
        return std::nullopt;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // '(' ')'
            ...
            auto _literal_1 = lexer.expect().punct(lex::Punct::RPAR);
            if (_literal_1) {
                _res = ast::make_field<ast::expr>( ast::Tuple ( ast::make_sequence ( ) ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // '(' ','.expr+ ','? ')'
            ...
            auto _literal_1 = lexer.expect().punct(lex::Punct::RPAR);
            if (_literal_1) {
                _res = ast::make_field<ast::expr>( ast::Tuple ( std::move ( a ) ));
                return _res;
            }
            }
            }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // '[' ']'
            ...
            auto _literal_1 = lexer.expect().punct(lex::Punct::RSQB);
            if (_literal_1) {
                _res = ast::make_field<ast::expr>( ast::Array ( ast::make_sequence ( ) ));
                return _res;
            }
            }
            seek(_state);
        ...
        { // '[' ','.expr+ ','? ']'
            ...
            auto _literal_1 = lexer.expect().punct(lex::Punct::RSQB);
            if (_literal_1) {
                _res = ast::make_field<ast::expr>( ast::Array ( std::move ( a ) ));
                return _res;
            }
            }
            }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'ctime'? '{' stmt* expr_or_unit '}'
            ...
            if (_user_opt_v) { auto v = std::move(_user_opt_v.value());
            auto _literal_1 = lexer.expect().punct(lex::Punct::RBRACE);
            if (_literal_1) {
                _res = ast::make_field<ast::expr>( ast::Block ( std::move ( b ) , std::move ( v ) , bool ( c ) ));
                return _res;
            }
            }
            }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'func' name '(' func_args_def ')' type_annotation? '=>' expr ';'
            ...
            if (_literal_3) {
                _res = ast::make_field<ast::expr>( ast::FuncDef ( std::move ( n ) , std::move ( a ) , std::move ( t ) , std::move ( b ) ));
                return _res;
            }
            }
            }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        (void)_state;
        { // 
                _res = ast::make_field<ast::arg_defs>( ast::arg_defs ( ast::make_sequence ( ) ));
                return _res;
            seek(_state);
        }
        return std::nullopt;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        std::vector<ast::stmt> _children{};
        size_t _n = 0;
        { // stmt
            while (true) {
                auto _user_opt_stmt_var = parse_stmt_rule();
                if (_user_opt_stmt_var) { auto stmt_var = std::move(_user_opt_stmt_var.value());
                    ...
                    _res = stmt_var;
                    _children.push_back(_res.value());
                    _state = tell();
                    continue;
                }
                break;
        ...
        auto _seq = ast::make_sequence<ast::stmt>(std::move(_res));
        return _seq;
    }
    #else
    ;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        auto _seq = ast::make_sequence<ast::expr>(std::move(_res));
        return _seq;
    }
    #else
    ;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // comparison_followup_pair
            while (true) {
                auto _user_opt_comparison_followup_pair_var = parse_comparison_followup_pair_rule();
                if (_user_opt_comparison_followup_pair_var) { auto comparison_followup_pair_var = std::move(_user_opt_comparison_followup_pair_var.value());
        ...
        auto _seq = ast::make_sequence<std::vector<std::pair < ast::cmp_op , ast::expr >>>(std::move(_res));
        return _seq;
    }
    #else
    ;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // STRING
            while (true) {
                auto _user_opt_STRING_var = lexer.expect().token(lex::TokenType::string);
                if (_user_opt_STRING_var) { auto STRING_var = *_user_opt_STRING_var;
        ...
        auto _seq = ast::make_sequence<std::vector<lex::Token>>(std::move(_res));
        return _seq;
    }
    #else
    ;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // ',' expr
            while (true) {
                ...
                if (_user_opt_elem) { auto elem = std::move(_user_opt_elem.value());
                    _res = elem;
                    _children.push_back(_res.value());
                    _state = tell();
                    continue;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // expr _loop0_8
            ...
            if (_user_opt_seq) { auto seq = std::move(_user_opt_seq.value());
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'or' conjunction_expr
            ...
            if (_user_opt_c) { auto c = std::move(_user_opt_c.value());
                _res = c;
                return _res;
            }
            }
