...
protected:
    ...
    // _loop1_23: STRING
    std::optional<std::vector<lex::Token>> parse__loop1_23_rule();

    // _loop0_25: ',' expr
    std::optional<ast::sequence<ast::expr>> parse__loop0_25_rule();

    // _gather_24: expr _loop0_25
    std::optional<ast::sequence<ast::expr>> parse__gather_24_rule();

    // _loop0_27: ',' expr
    std::optional<ast::sequence<ast::expr>> parse__loop0_27_rule();

    // _gather_26: expr _loop0_27
    std::optional<ast::sequence<ast::expr>> parse__gather_26_rule();

    // _loop0_28: stmt
    std::optional<ast::sequence<ast::stmt>> parse__loop0_28_rule();
