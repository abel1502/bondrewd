...
protected:
    ...
    // start: cartridge
    std::optional<ast::field<ast::cartridge>> parse_start()
    ...
    std::optional<ast::field<ast::cartridge>> parse_cartridge()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::cartridge>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::stmt>> parse_stmt()
    #ifdef BONDREWD_PARSER_IMPL
    {
    ...
    std::optional<ast::field<ast::stmt>> parse_assign_stmt()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::stmt>> _res = std::nullopt;
        { // expr assign_op expr ';'
    ...
    // assign_op: '=' | '+=' | '-=' | '*=' | '/=' | '%=' | '<<=' | '>>=' | '&=' | '|=' | '^='
    std::optional<ast::field<ast::assign_op>> parse_assign_op()
    #ifdef BONDREWD_PARSER_IMPL
    {
    ...
    std::optional<ast::field<ast::stmt>> parse_var_def_stmt()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::stmt>> _res = std::nullopt;
    ...
    // impl_stmt: 
    std::optional<ast::field<ast::stmt>> parse_impl_stmt()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::stmt>> _res = std::nullopt;
        _res = std::nullopt;
    ...
    // expr_stmt: expr ';'
    std::optional<ast::field<ast::stmt>> parse_expr_stmt()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::stmt>> _res = std::nullopt;
        { // expr ';'
    ...
    //     | 'break' expr_or_unit
    //     | disjunction_expr
    std::optional<ast::field<ast::expr>> parse_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
    ...
    // expr_or_unit: expr | 
    std::optional<ast::field<ast::expr>> parse_expr_or_unit()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // expr
    ...
    std::optional<ast::field<ast::expr>> parse_disjunction_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_conjunction_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_inversion_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // 'not' inversion_expr
    ...
    std::optional<ast::field<ast::expr>> parse_comparison_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::cmp_op>> parse_comparison_op()
    #ifdef BONDREWD_PARSER_IMPL
    {
    ...
    std::optional<ast::field<ast::expr>> parse_bidir_cmp_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_bitor_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_bitxor_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_bitand_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_shift_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_sum_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_term_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_factor_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // '+' factor_expr
    ...
    std::optional<ast::field<ast::expr>> parse_power_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_primary_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    //     | array_expr
    //     | block_expr
    std::optional<ast::field<ast::expr>> parse_atom_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // name
    ...
    // call_args: 
    std::optional<ast::field<ast::call_args>> parse_call_args()
    #ifdef BONDREWD_PARSER_IMPL
    {
    ...
    // group_expr: '(' expr ')'
    std::optional<ast::field<ast::expr>> parse_group_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // '(' expr ')'
    ...
    // tuple_expr: '(' ')' | '(' ','.expr+ ','? ')'
    std::optional<ast::field<ast::expr>> parse_tuple_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // '(' ')'
    ...
    // array_expr: '[' ']' | '[' ','.expr+ ','? ']'
    std::optional<ast::field<ast::expr>> parse_array_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // '[' ']'
    ...
    std::optional<ast::field<ast::expr>> parse_block_expr()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    std::optional<ast::field<ast::expr>> parse_type_annotation()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // ':' expr
    ...
    std::optional<ast::field<ast::expr>> parse_func_def()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    // func_args_def: 
    std::optional<ast::field<ast::arg_defs>> parse_func_args_def()
    #ifdef BONDREWD_PARSER_IMPL
    {
    ...
    std::optional<ast::field<ast::expr>> parse_class_def()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
    ...
    // _loop0_1: stmt
    std::optional<ast::sequence<ast::stmt>> parse__loop0_1()
    #ifdef BONDREWD_PARSER_IMPL
    {
    ...
    // _tmp_2: '=' expr
    std::optional<ast::field<ast::expr>> parse__tmp_2()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // '=' expr
    ...
    std::optional<ast::sequence<ast::expr>> parse__loop1_3()
    #ifdef BONDREWD_PARSER_IMPL
    {
    ...
    std::optional<ast::sequence<ast::expr>> parse__loop1_4()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::sequence<ast::expr>> _res = std::nullopt;
        auto _state = tell();
    ...
    // _loop0_11: stmt
    std::optional<ast::sequence<ast::stmt>> parse__loop0_11()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::sequence<ast::stmt>> _res = std::nullopt;
        auto _state = tell();
    ...
    std::optional<ast::field<ast::expr>> parse__tmp_12()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // 'or' conjunction_expr
    ...
    std::optional<ast::field<ast::expr>> parse__tmp_13()
    #ifdef BONDREWD_PARSER_IMPL
    {
        std::optional<ast::field<ast::expr>> _res = std::nullopt;
        { // 'and' inversion_expr
