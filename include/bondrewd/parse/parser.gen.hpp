// AUTOGENERATED by bondrewd/tools/pegen++/pegenxx.py on 2023-03-13 21:33:07
// DO NOT EDIT
...
protected:
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // cartridge_header stmt*
            ...
            if (_user_opt_h) { auto h = *_user_opt_h;
            auto _user_opt_b = parse__loop0_1_rule();
            if (_user_opt_b) { auto b = *_user_opt_b;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'cartridge' name ';'
            ...
            if (_user_opt_n) { auto n = *_user_opt_n;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // expr assign_op expr ';'
            ...
            if (_user_opt_op) { auto op = *_user_opt_op;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'ctime'? 'var' name type_annotation? ['=' expr] ';'
            ...
            auto _literal = lexer.expect().punct(lex::Punct::SEMI);
            if (_literal) {
                _res = ast::VarDef ( std::move ( n ) , t ? * t : nullptr , v ? * v : nullptr , true , bool ( c ) );
                return _res;
            }
            }
            }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // comparison_op bidir_cmp_expr
            ...
            if (_user_opt_o) { auto o = *_user_opt_o;
            auto _user_opt_a = parse_bidir_cmp_expr_rule();
            if (_user_opt_a) { auto a = *_user_opt_a;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'ctime'? '{' stmt* expr_or_unit '}'
            ...
            if (_user_opt_v) { auto v = *_user_opt_v;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'func' name '(' func_args_def ')' type_annotation? '=>' expr ';'
            ...
            if (_literal_3) {
                _res = ast::FuncDef ( std::move ( n ) , std::move ( a ) , t ? * t : nullptr , std::move ( b ) );
                return _res;
            }
            }
            }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // ',' expr
            while (true) {
                ...
                if (_user_opt_elem) { auto elem = *_user_opt_elem;
                    _res = elem;
                    _children.push_back(*_res);
                    _state = tell();
                    continue;
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // expr _loop0_8
            ...
            if (_user_opt_expr_var) { auto expr_var = *_user_opt_expr_var;
            auto _user_opt_seq = parse__loop0_8_rule();
            if (_user_opt_seq) { auto seq = *_user_opt_seq;
                _res = std::move(seq);
                return _res;
            }
            }
    ...
    #ifdef BONDREWD_PARSER_IMPL
    {
        ...
        { // 'or' conjunction_expr
            ...
            if (_user_opt_c) { auto c = *_user_opt_c;
                _res = c;
                return _res;
            }
            }
