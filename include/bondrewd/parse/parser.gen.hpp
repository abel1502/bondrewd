...
protected:
    ...
    // _loop0_4: ',' arg_spec
    std::optional<ast::sequence<ast::arg_spec>> parse__loop0_4_rule();

    // _gather_3: arg_spec _loop0_4
    std::optional<ast::sequence<ast::arg_spec>> parse__gather_3_rule();

    // _loop0_6: ',' arg_spec
    std::optional<ast::sequence<ast::arg_spec>> parse__loop0_6_rule();

    // _gather_5: arg_spec _loop0_6
    std::optional<ast::sequence<ast::arg_spec>> parse__gather_5_rule();

    // _tmp_7: '=' expr
    std::optional<ast::field<ast::expr>> parse__tmp_7_rule();

    // _loop0_8: stmt
    std::optional<ast::sequence<ast::stmt>> parse__loop0_8_rule();

    // _tmp_9: 'class' | 'struct'
    std::optional<std::monostate> parse__tmp_9_rule();
    ...
    std::optional<std::vector<std::pair < ast::field < ast::cmp_op > , ast::field < ast::expr >>>> parse__loop1_15_rule();
    ...
    std::optional<ast::field<ast::expr>> parse__tmp_24_rule();

    // _tmp_25: shift_expr | expr_4
    std::optional<ast::field<ast::expr>> parse__tmp_25_rule();

    // _tmp_26: unary_expr | expr_5
    std::optional<ast::field<ast::expr>> parse__tmp_26_rule();

    // _tmp_27: unary_expr | expr_5
    std::optional<ast::field<ast::expr>> parse__tmp_27_rule();

    // _tmp_28: unary_expr | expr_5
    std::optional<ast::field<ast::expr>> parse__tmp_28_rule();
    ...
    // _loop1_31: STRING
    std::optional<std::vector<lex::Token>> parse__loop1_31_rule();

    // _loop0_33: ',' expr
    std::optional<ast::sequence<ast::expr>> parse__loop0_33_rule();

    // _gather_32: expr _loop0_33
    std::optional<ast::sequence<ast::expr>> parse__gather_32_rule();

    // _loop0_35: ',' expr
    std::optional<ast::sequence<ast::expr>> parse__loop0_35_rule();

    // _gather_34: expr _loop0_35
    std::optional<ast::sequence<ast::expr>> parse__gather_34_rule();

    // _loop0_36: stmt
    std::optional<ast::sequence<ast::stmt>> parse__loop0_36_rule();

    // _tmp_37: 'and' expr_1
    std::optional<ast::field<ast::expr>> parse__tmp_37_rule();

    // _tmp_38: 'or' expr_1
    std::optional<ast::field<ast::expr>> parse__tmp_38_rule();
