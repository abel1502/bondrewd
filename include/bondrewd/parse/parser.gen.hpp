...
protected:
    ...
    // _loop1_16: STRING
    std::optional<std::vector<lex::Token>> parse__loop1_16_rule();

    // _loop0_18: ',' expr
    std::optional<ast::sequence<ast::expr>> parse__loop0_18_rule();

    // _gather_17: expr _loop0_18
    std::optional<ast::sequence<ast::expr>> parse__gather_17_rule();

    // _loop0_20: ',' expr
    std::optional<ast::sequence<ast::expr>> parse__loop0_20_rule();

    // _gather_19: expr _loop0_20
    std::optional<ast::sequence<ast::expr>> parse__gather_19_rule();

    // _loop0_21: stmt
    std::optional<ast::sequence<ast::stmt>> parse__loop0_21_rule();
