...
protected:
    ...
    // _loop0_6: stmt
    std::optional<ast::sequence<ast::stmt>> parse__loop0_6_rule();
    ...
    std::optional<ast::sequence<ast::expr>> parse__loop1_10_rule();

    // _loop1_11: ('and' inversion_expr)
    std::optional<ast::sequence<ast::expr>> parse__loop1_11_rule();

    // _loop1_12: comparison_followup_pair
    std::optional<std::vector<std::pair < ast::field < ast::cmp_op > , ast::field < ast::expr >>>> parse__loop1_12_rule();

    // _loop1_13: STRING
    std::optional<std::vector<lex::Token>> parse__loop1_13_rule();

    // _loop0_15: ',' expr
    std::optional<ast::sequence<ast::expr>> parse__loop0_15_rule();

    // _gather_14: expr _loop0_15
    std::optional<ast::sequence<ast::expr>> parse__gather_14_rule();

    // _loop0_17: ',' expr
    std::optional<ast::sequence<ast::expr>> parse__loop0_17_rule();

    // _gather_16: expr _loop0_17
    std::optional<ast::sequence<ast::expr>> parse__gather_16_rule();

    // _loop0_18: stmt
    std::optional<ast::sequence<ast::stmt>> parse__loop0_18_rule();
