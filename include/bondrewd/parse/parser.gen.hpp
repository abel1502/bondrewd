...
protected:
    ...
    // ns_spec_raw: '::'.name+
    std::optional<ast::sequence < identifier >> parse_ns_spec_raw_rule();
    ...
    // _loop1_24: STRING
    std::optional<std::vector<lex::Token>> parse__loop1_24_rule();
    ...
    // _loop0_28: ',' expr
    std::optional<ast::sequence<ast::expr>> parse__loop0_28_rule();

    // _gather_27: expr _loop0_28
    std::optional<ast::sequence<ast::expr>> parse__gather_27_rule();

    // _loop0_29: stmt
    std::optional<ast::sequence<ast::stmt>> parse__loop0_29_rule();

    // _tmp_30: ',' arg_spec
    std::optional<ast::field<ast::arg_spec>> parse__tmp_30_rule();

    // _tmp_31: 'and' expr_1
    std::optional<ast::field<ast::expr>> parse__tmp_31_rule();

    // _tmp_32: 'or' expr_1
    std::optional<ast::field<ast::expr>> parse__tmp_32_rule();
