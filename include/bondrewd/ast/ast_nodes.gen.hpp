// AUTOGENERATED by bondrewd/tools/asdl++/asdl_cpp.py on 2023-04-24 21:29:23
// DO NOT EDIT
...
class DotAttribute : public _ConcreteASTNode {
public:
    #pragma region Fields
    field<expr> value;
    identifier attr;
    ...
    #pragma region Constructors
    DotAttribute(field<expr> value, identifier attr) :
        value{std::move(value)}, attr{std::move(attr)} {}
    #pragma endregion Constructors
    
    #pragma region Service constructors
    DotAttribute(const DotAttribute &) = delete;
    DotAttribute(DotAttribute &&) = default;
    DotAttribute &operator=(const DotAttribute &) = delete;
    DotAttribute &operator=(DotAttribute &&) = default;
    #pragma endregion Service constructors
...
class ColonAttribute : public _ConcreteASTNode {
public:
    #pragma region Fields
    field<expr> value;
    identifier attr;
    ...
    #pragma region Constructors
    ColonAttribute(field<expr> value, identifier attr) :
        value{std::move(value)}, attr{std::move(attr)} {}
    #pragma endregion Constructors
    
    #pragma region Service constructors
    ColonAttribute(const ColonAttribute &) = delete;
    ColonAttribute(ColonAttribute &&) = default;
    ColonAttribute &operator=(const ColonAttribute &) = delete;
    ColonAttribute &operator=(ColonAttribute &&) = default;
    #pragma endregion Service constructors
...
class expr : public _AST<VarRef, Constant, DotAttribute, ColonAttribute, Call, MacroCall, InfixCall, Subscript, CtimeBlock, Block, Defn, BinOp, UnOp, Compare, BoolOp, Flow, Return, Break, Continue, Expand, Tuple, Array, TokenStream, PassSpec> {
public:
    #pragma region Constructors
    expr(auto &&value_)
        : _AST(std::forward<decltype(value_)>(value_)) {}
