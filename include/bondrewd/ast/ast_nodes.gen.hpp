// AUTOGENERATED by bondrewd/tools/asdl++/asdl_cpp.py on 2023-04-03 10:19:36
// DO NOT EDIT
...
class Cartridge : public _ConcreteASTNode {
public:
    ...
    Cartridge(identifier name, sequence<stmt> body) :
    ...
    #pragma region Casts
    // TODO: Explicit?
    operator ast::field<cartridge>() {
        return ast::make_field<cartridge>(std::move(*this));
    }
...
class stmt : public _AST<Assign, Expr, Pass> {
public:
    #pragma region Constructors
    stmt(auto &&value_)
        : _AST(std::forward<decltype(value_)>(value_)) {}
...
class expr : public _AST<Name, Constant, Attribute, Call, Subscript, Block, Defn, BinOp, UnOp, Compare, BoolOp, Flow, Return, Break, Continue, Tuple, Array> {
public:
    #pragma region Constructors
    expr(auto &&value_)
        : _AST(std::forward<decltype(value_)>(value_)) {}
...
public:
    ...
    #pragma region Constructors
    ImplDef(identifier class_name, std::optional<identifier> trait_name, field<expr> body) :
        class_name{std::move(class_name)}, trait_name{std::move(trait_name)}, body{std::move(body)} {}
    #pragma endregion Constructors
     ...
     */
    auto get_fields_tuple() {
        return std::tie(class_name, trait_name, body);
    }
...
class ClassDef : public _ConcreteASTNode {
public:
    #pragma region Fields
    identifier name;
    field<expr> body;
    ...
    #pragma region Constructors
    ClassDef(identifier name, field<expr> body) :
        name{std::move(name)}, body{std::move(body)} {}
    #pragma endregion Constructors
...
class defn : public _AST<VarDef, ImplDef, FuncDef, ClassDef> {
public:
    #pragma region Constructors
...
public:
    #pragma region Constructors
    flow(auto &&value_, field<xtime_flag> flag)
        : _AST(std::forward<decltype(value_)>(value_)), std::move(flag) {}
    #pragma endregion Constructors
...
public:
    ...
    #pragma region Casts
    // TODO: Explicit?
    operator ast::field<arg_defs>() {
        return ast::make_field<arg_defs>(std::move(*this));
    }
    #pragma endregion Casts
...
public:
    ...
    #pragma region Casts
    // TODO: Explicit?
    operator ast::field<arg_def>() {
        return ast::make_field<arg_def>(std::move(*this));
    }
    #pragma endregion Casts
