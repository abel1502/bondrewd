// AUTOGENERATED by bondrewd/tools/asdl++/asdl_cpp.py on 2023-03-15 13:15:10
// DO NOT EDIT
...
class Impl : public _ConcreteASTNode {
public:
    #pragma region Fields
...
class arg_defs : public _ConcreteASTNode {
public:
    #pragma region Fields
...
class arg_def : public _ConcreteASTNode {
public:
    #pragma region Fields
    identifier name;
    field<expr> type;
...
class call_args : public _ConcreteASTNode {
public:
    #pragma region Fields
...
class call_arg : public _ConcreteASTNode {
public:
    #pragma region Fields
