// AUTOGENERATED by bondrewd/tools/asdl++/asdl_cpp.py on 2023-04-17 15:43:50
// DO NOT EDIT
...
class expr : public _AST<VarRef, Constant, Attribute, Call, MacroCall, InfixCall, Subscript, CtimeBlock, Block, Defn, BinOp, UnOp, Compare, BoolOp, Flow, Return, Break, Continue, Expand, Tuple, Array, TokenStream> {
public:
    #pragma region Constructors
    expr(auto &&value_)
        : _AST(std::forward<decltype(value_)>(value_)) {}
