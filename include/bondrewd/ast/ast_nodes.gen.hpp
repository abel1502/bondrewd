// AUTOGENERATED by bondrewd/tools/asdl++/asdl_cpp.py on 2023-04-06 22:33:47
// DO NOT EDIT
...
class expr : public _AST<Name, Constant, Attribute, Call, Subscript, CtimeBlock, Block, Defn, BinOp, UnOp, Compare, BoolOp, Flow, Return, Break, Continue, Tuple, Array> {
public:
    #pragma region Constructors
    expr(auto &&value_)
        : _AST(std::forward<decltype(value_)>(value_)) {}
...
public:
    ...
    #pragma region Constructors
    StructDef(std::optional<identifier> name, field<args_spec> args) :
...
class defn : public _AST<VarDef, ImplDef, FuncDef, StructDef> {
public:
    #pragma region Constructors
...
public:
    ...
    #pragma region Constructors
    arg_spec(identifier name, field<expr> type, maybe<expr> default) :
        name{std::move(name)}, type{std::move(type)}, default{std::move(default)} {}
    #pragma endregion Constructors
     ...
     */
    auto get_fields_tuple() {
        return std::tie(name, type, default);
    }
