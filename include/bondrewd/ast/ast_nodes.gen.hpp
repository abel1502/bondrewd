// AUTOGENERATED by bondrewd/tools/asdl++/asdl_cpp.py on 2023-04-07 13:31:19
// DO NOT EDIT
...
class expr : public _AST<VarRef, Constant, Attribute, Call, InfixCall, Subscript, CtimeBlock, Block, Defn, BinOp, UnOp, Compare, BoolOp, Flow, Return, Break, Continue, Tuple, Array> {
public:
    #pragma region Constructors
    expr(auto &&value_)
        : _AST(std::forward<decltype(value_)>(value_)) {}
...
public:
    #pragma region Fields
    sequence<identifier> parents;
    identifier name;
    #pragma endregion Fields

    #pragma region Constructors
    NsDef(sequence<identifier> parents, identifier name) :
...
class defn : public _AST<VarDef, ImplDef, FuncDef, StructDef, NsDef> {
public:
    #pragma region Constructors
