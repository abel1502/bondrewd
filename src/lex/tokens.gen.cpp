// AUTOGENERATED by bondrewd/tools/tokens/generate_tokens.py on 2023-06-07 19:23:03
// DO NOT EDIT
...
const char *keyword_to_string(HardKeyword value) {
    switch (value) {
        ...
        case HardKeyword::UNWRAP: return "unwrap";
        ...
        case HardKeyword::ASYNC: return "async";
        case HardKeyword::AWAIT: return "await";
...
const std::unordered_map<std::string_view, HardKeyword> string_to_keyword = {
    ...
    { "async", HardKeyword::ASYNC },
    { "await", HardKeyword::AWAIT },
