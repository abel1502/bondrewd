// AUTOGENERATED by bondrewd/tools/tokens/generate_tokens.py on 2023-04-03 16:28:06
// DO NOT EDIT
...
const char *keyword_to_string(HardKeyword value) {
    switch (value) {
        ...
        case HardKeyword::NAMESPACE: return "namespace";
...
const std::unordered_map<std::string_view, HardKeyword> string_to_keyword = {
    ...
    { "namespace", HardKeyword::NAMESPACE },
