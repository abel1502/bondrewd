// AUTOGENERATED by bondrewd/tools/pegen++/pegenxx.py on 2023-04-03 10:20:23
// DO NOT EDIT
...
// var_def: 'ctime'? 'var' name type_annotation? ['=' expr] ';'
std::optional<ast::field<ast::stmt>> Parser::parse_var_def_rule()
{
    ...
    { // 'ctime'? 'var' name type_annotation? ['=' expr] ';'
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "var_def", _state, tell(), "'ctime'? 'var' name type_annotation? ['=' expr] ';'");
