...
std::optional<ast::field<ast::defn>> Parser::parse_defn_rule()
{
    ...
    { // 'ctime' raw_defn
        ...
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "defn", _state, tell(), "'ctime' raw_defn");
            _res = ( {a . flag = ast::CTime ( ) ; std::move ( a )} );
    ...
    { // 'rtime' raw_defn
        ...
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "defn", _state, tell(), "'rtime' raw_defn");
            _res = ( {a . flag = ast::RTime ( ) ; std::move ( a )} );
...
std::optional<ast::field<ast::stmt>> Parser::parse_var_def_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
...
std::optional<ast::field<ast::expr>> Parser::parse_func_def_rule()
{
    ...
    { // 'func' name '(' func_args_def ')' type_annotation? '=>' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "func_def", _state, tell(), "'func' name '(' func_args_def ')' type_annotation? '=>' expr");
        ...
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "func_def", _state, tell(), "'func' name '(' func_args_def ')' type_annotation? '=>' expr");
            _res = ast::FuncDef ( std::move ( n ) , std::move ( a ) , _opt2maybe ( std::move ( t ) ) );
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "'func' name '(' func_args_def ')' type_annotation? '=>' expr");
            --_level;
            return _res;
        }
        }
...
std::optional<ast::field<ast::flow>> Parser::parse_if_flow_rule()
{
    ...
    { // 'if' expr flow_block [('else' flow_block)]
        ...
        auto _user_opt_e = parse__tmp_3_rule();
        if (true) { auto e = _user_opt_e;
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "if_flow", _state, tell(), "'if' expr flow_block [('else' flow_block)]");
            _res = ast::If ( std::move ( a ) , std::move ( b ) , _opt2maybe ( std::move ( c ) ) );
...
std::optional<ast::field<ast::flow>> Parser::parse_for_flow_rule()
{
    ...
    { // 'for' name 'in' expr flow_block [('else' flow_block)]
        ...
        auto _user_opt_t = parse_flow_block_rule();
        if (_user_opt_t) { auto t = std::move(*_user_opt_t);
        auto _user_opt_e = parse__tmp_4_rule();
        if (true) { auto e = _user_opt_e;
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "for_flow", _state, tell(), "'for' name 'in' expr flow_block [('else' flow_block)]");
            _res = ast::For ( std::move ( v ) , std::move ( c ) , std::move ( t ) , _opt2maybe ( std::move ( e ) ) );
...
std::optional<ast::field<ast::flow>> Parser::parse_while_flow_rule()
{
    ...
    { // 'while' expr flow_block [('else' flow_block)]
        ...
        auto _user_opt_t = parse_flow_block_rule();
        if (_user_opt_t) { auto t = std::move(*_user_opt_t);
        auto _user_opt_e = parse__tmp_5_rule();
        if (true) { auto e = _user_opt_e;
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "while_flow", _state, tell(), "'while' expr flow_block [('else' flow_block)]");
            _res = ast::While ( std::move ( c ) , std::move ( t ) , _opt2maybe ( std::move ( e ) ) );
...
std::optional<ast::field<ast::expr>> Parser::parse_disjunction_expr_rule()
{
    ...
    { // conjunction_expr (('or' conjunction_expr))+
        ...
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _user_opt_b = parse__loop1_6_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "disjunction_expr", _state, tell(), "conjunction_expr (('or' conjunction_expr))+");
...
std::optional<ast::field<ast::expr>> Parser::parse_conjunction_expr_rule()
{
    ...
    { // inversion_expr (('and' inversion_expr))+
        ...
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _user_opt_b = parse__loop1_7_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "conjunction_expr", _state, tell(), "inversion_expr (('and' inversion_expr))+");
...
std::optional<ast::field<ast::expr>> Parser::parse_comparison_expr_rule()
{
    ...
    { // bidir_cmp_expr comparison_followup_pair+
        ...
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _user_opt_b = parse__loop1_8_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "comparison_expr", _state, tell(), "bidir_cmp_expr comparison_followup_pair+");
...
std::optional<std::string> Parser::parse_strings_rule()
{
    ...
    { // STRING+
        ...
        auto _user_opt_a = parse__loop1_9_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "strings", _state, tell(), "STRING+");
...
std::optional<ast::field<ast::expr>> Parser::parse_tuple_expr_rule()
{
    ...
    { // '(' ','.expr+ ','? ')'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LPAR);
        if (_literal) {
        auto _user_opt_a = parse__gather_10_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
...
std::optional<ast::field<ast::expr>> Parser::parse_array_expr_rule()
{
    ...
    { // '[' ','.expr+ ','? ']'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LSQB);
        if (_literal) {
        auto _user_opt_a = parse__gather_12_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _opt_var = lexer.expect().punct(lex::Punct::COMMA);
        if (true) { (void)_opt_var;
        auto _literal_1 = lexer.expect().punct(lex::Punct::RSQB);
...
std::optional<ast::field<ast::expr>> Parser::parse_block_expr_rule()
{
    ...
    { // 'ctime'? '{' stmt* expr_or_unit '}'
        ...
        if (_literal) {
        auto _user_opt_b = parse__loop0_14_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_3_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'else' flow_block
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_3", _state, tell(), "'else' flow_block");
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_4_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'else' flow_block
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_4", _state, tell(), "'else' flow_block");
        auto _keyword = lexer.expect().keyword(lex::HardKeyword::ELSE);
        if (_keyword) {
        auto _single_result = parse_flow_block_rule();
        if (_single_result) {
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_5_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'else' flow_block
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_5", _state, tell(), "'else' flow_block");
        auto _keyword = lexer.expect().keyword(lex::HardKeyword::ELSE);
        if (_keyword) {
        auto _single_result = parse_flow_block_rule();
        if (_single_result) {
...
std::optional<ast::sequence<ast::expr>> Parser::parse__loop1_6_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // ('or' conjunction_expr)
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_6", _state, tell(), "('or' conjunction_expr)");
        while (true) {
            auto _single_result = parse__tmp_15_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
std::optional<ast::sequence<ast::expr>> Parser::parse__loop1_7_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ('and' inversion_expr)
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_7", _state, tell(), "('and' inversion_expr)");
        while (true) {
            auto _single_result = parse__tmp_16_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
std::optional<std::vector<std::pair < ast::field < ast::cmp_op > , ast::field < ast::expr >>>> Parser::parse__loop1_8_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // comparison_followup_pair
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_8", _state, tell(), "comparison_followup_pair");
        while (true) {
...
// _loop1_9: STRING
std::optional<std::vector<lex::Token>> Parser::parse__loop1_9_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // STRING
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_9", _state, tell(), "STRING");
        while (true) {
...
// _loop0_11: ',' expr
std::optional<ast::sequence<ast::expr>> Parser::parse__loop0_11_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ',' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_11", _state, tell(), "',' expr");
        while (true) {
...
std::optional<ast::sequence<ast::expr>> Parser::parse__gather_10_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
...
// _loop0_13: ',' expr
std::optional<ast::sequence<ast::expr>> Parser::parse__loop0_13_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ',' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_13", _state, tell(), "',' expr");
        while (true) {
            auto _literal = lexer.expect().punct(lex::Punct::COMMA);
            if (_literal) {
            auto _user_opt_elem = parse_expr_rule();
...
std::optional<ast::sequence<ast::expr>> Parser::parse__gather_12_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::sequence<ast::expr>> _res = std::nullopt;
    { // expr _loop0_13
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_gather_12", _state, tell(), "expr _loop0_13");
        auto _user_opt_expr_var = parse_expr_rule();
        if (_user_opt_expr_var) { auto expr_var = std::move(*_user_opt_expr_var);
        auto _user_opt_seq = parse__loop0_13_rule();
        if (_user_opt_seq) { auto seq = std::move(*_user_opt_seq);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_gather_12", _state, tell(), "expr _loop0_13");
            _res = std::move(seq);
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "expr _loop0_13");
            --_level;
            return _res;
        }
        }
...
// _loop0_14: stmt
std::optional<ast::sequence<ast::stmt>> Parser::parse__loop0_14_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::stmt>> _children{};
    { // stmt
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_14", _state, tell(), "stmt");
        while (true) {
            auto _single_result = parse_stmt_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_15_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'or' conjunction_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_15", _state, tell(), "'or' conjunction_expr");
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_16_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'and' inversion_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_16", _state, tell(), "'and' inversion_expr");
