...
std::optional<ast::field<ast::defn>> Parser::parse_ns_def_rule()
{
    ...
    std::optional<ast::field<ast::defn>> _res = std::nullopt;
    { // 'ns' name
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "ns_def", _state, tell(), "'ns' name");
...
std::optional<ast::field<ast::args_spec>> Parser::parse_args_spec_nonempty_rule()
{
    ...
    { // "self" ((',' arg_spec))*
        ...
        if (_keyword) {
        auto _user_opt_a = parse__loop0_5_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "args_spec_nonempty", _state, tell(), "\"self\" ((',' arg_spec))*");
    ...
    { // ','.arg_spec+
        ...
        auto _user_opt_a = parse__gather_6_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "args_spec_nonempty", _state, tell(), "','.arg_spec+");
...
std::optional<ast::field<ast::arg_spec>> Parser::parse_arg_spec_rule()
{
    ...
    { // name type_annotation [('=' expr)]
        ...
        auto _user_opt_t = parse_type_annotation_rule();
        if (_user_opt_t) { auto t = std::move(*_user_opt_t);
        auto _user_opt_d = parse__tmp_8_rule();
...
std::optional<ast::field<ast::flow>> Parser::parse_if_flow_rule()
{
    ...
    { // 'if' expr flow_block [('else' flow_block)]
        ...
        if (_user_opt_t) { auto t = std::move(*_user_opt_t);
        auto _user_opt_e = parse__tmp_9_rule();
...
std::optional<ast::field<ast::expr>> Parser::parse_flow_block_rule()
{
    ...
    { // keyword_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "flow_block", _state, tell(), "keyword_expr");
        auto _single_result = parse_keyword_expr_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "flow_block", _state, tell(), "keyword_expr");
            _res = std::move(_single_result);
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "keyword_expr");
            --_level;
            return _res;
        }
        seek(_state);
...
std::optional<ast::field<ast::expr>> Parser::parse_expr_rule()
{
    ...
    { // keyword_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "expr", _state, tell(), "keyword_expr");
        auto _single_result = parse_keyword_expr_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "expr", _state, tell(), "keyword_expr");
            _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse_keyword_expr_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // return_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "keyword_expr", _state, tell(), "return_expr");
    ...
    { // break_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "keyword_expr", _state, tell(), "break_expr");
    ...
    { // continue_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "keyword_expr", _state, tell(), "continue_expr");
...
std::optional<ast::field<ast::expr>> Parser::parse_and_expr_rule()
{
    ...
    { // expr_2 (('and' expr_1))+
        ...
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _user_opt_b = parse__loop1_12_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "and_expr", _state, tell(), "expr_2 (('and' expr_1))+");
...
std::optional<ast::field<ast::expr>> Parser::parse_comparison_expr_rule()
{
    ...
    { // expr_3 comparison_followup_pair+
        ...
        if (_user_opt_f) { auto f = std::move(*_user_opt_f);
        auto _user_opt_n = parse__loop1_14_rule();
        if (_user_opt_n) { auto n = std::move(*_user_opt_n);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "comparison_expr", _state, tell(), "expr_3 comparison_followup_pair+");
...
std::optional<ast::field<ast::expr>> Parser::parse_raw_sum_expr()
{
    ...
    { // (sum_expr | product_expr) sum_bin_op product_expr
        ...
        auto _user_opt_a = parse__tmp_15_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
...
// sum_bin_op: '+' | '-'
std::optional<ast::field<ast::bin_op>> Parser::parse_sum_bin_op_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    const auto _state = tell();
    (void)_state;
    std::optional<ast::field<ast::bin_op>> _res = std::nullopt;
    { // '+'
...
// product_bin_op: '*' | '/' | '%'
std::optional<ast::field<ast::bin_op>> Parser::parse_product_bin_op_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
...
// shift_bin_op: '<<' | '>>'
std::optional<ast::field<ast::bin_op>> Parser::parse_shift_bin_op_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
...
std::optional<std::string> Parser::parse_strings_rule()
{
    ...
    { // STRING+
        ...
        auto _user_opt_a = parse__loop1_22_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "strings", _state, tell(), "STRING+");
...
std::optional<ast::field<ast::expr>> Parser::parse_tuple_expr_rule()
{
    ...
    { // '(' ','.expr+ ','? ')'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LPAR);
        if (_literal) {
        auto _user_opt_a = parse__gather_23_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _opt_var = lexer.expect().punct(lex::Punct::COMMA);
        if (true) { (void)_opt_var;
        auto _literal_1 = lexer.expect().punct(lex::Punct::RPAR);
...
std::optional<ast::field<ast::expr>> Parser::parse_array_expr_rule()
{
    ...
    { // '[' ','.expr+ ','? ']'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LSQB);
        if (_literal) {
        auto _user_opt_a = parse__gather_25_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _opt_var = lexer.expect().punct(lex::Punct::COMMA);
        if (true) { (void)_opt_var;
        auto _literal_1 = lexer.expect().punct(lex::Punct::RSQB);
...
std::optional<ast::field<ast::expr>> Parser::parse_block_expr_rule()
{
    ...
    { // '{' stmt* expr_or_unit '}'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LBRACE);
        if (_literal) {
        auto _user_opt_b = parse__loop0_27_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
...
// _loop0_5: (',' arg_spec)
std::optional<ast::sequence<ast::arg_spec>> Parser::parse__loop0_5_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // (',' arg_spec)
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_5", _state, tell(), "(',' arg_spec)");
        while (true) {
            auto _single_result = parse__tmp_28_rule();
            if (_single_result) {
                _res = std::move(_single_result);
                PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "(',' arg_spec)");
                _children.push_back(std::move(*_res));
...
std::optional<ast::sequence<ast::arg_spec>> Parser::parse__gather_6_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // arg_spec _loop0_7
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_gather_6", _state, tell(), "arg_spec _loop0_7");
        ...
        auto _user_opt_seq = parse__loop0_7_rule();
        if (_user_opt_seq) { auto seq = std::move(*_user_opt_seq);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_gather_6", _state, tell(), "arg_spec _loop0_7");
            _res = std::move(seq);
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "arg_spec _loop0_7");
            --_level;
            return _res;
        }
        }
...
// _tmp_8: '=' expr
std::optional<ast::field<ast::expr>> Parser::parse__tmp_8_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // '=' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_8", _state, tell(), "'=' expr");
        auto _literal = lexer.expect().punct(lex::Punct::EQUAL);
        if (_literal) {
        auto _single_result = parse_expr_rule();
        if (_single_result) {
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_9_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'else' flow_block
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_9", _state, tell(), "'else' flow_block");
...
std::optional<ast::sequence<ast::expr>> Parser::parse__loop1_12_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // ('and' expr_1)
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_12", _state, tell(), "('and' expr_1)");
        while (true) {
            auto _single_result = parse__tmp_29_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
std::optional<ast::sequence<ast::expr>> Parser::parse__loop1_13_rule()
{
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ('or' expr_1)
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_13", _state, tell(), "('or' expr_1)");
        while (true) {
            auto _single_result = parse__tmp_30_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
std::optional<std::vector<std::pair < ast::field < ast::cmp_op > , ast::field < ast::expr >>>> Parser::parse__loop1_14_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // comparison_followup_pair
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_14", _state, tell(), "comparison_followup_pair");
        while (true) {
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_15_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // sum_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_15", _state, tell(), "sum_expr");
        auto _single_result = parse_sum_expr_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_tmp_15", _state, tell(), "sum_expr");
            _res = std::move(_single_result);
    ...
    { // product_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_15", _state, tell(), "product_expr");
        auto _single_result = parse_product_expr_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_tmp_15", _state, tell(), "product_expr");
            _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_16_rule()
{
    ...
    { // expr_4
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_16", _state, tell(), "expr_4");
        auto _single_result = parse_expr_4_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_tmp_16", _state, tell(), "expr_4");
            _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_17_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // bitor_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_17", _state, tell(), "bitor_expr");
        auto _single_result = parse_bitor_expr_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_tmp_17", _state, tell(), "bitor_expr");
            _res = std::move(_single_result);
    ...
    { // expr_4
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_17", _state, tell(), "expr_4");
        auto _single_result = parse_expr_4_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_tmp_17", _state, tell(), "expr_4");
            _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_18_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // bitand_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_18", _state, tell(), "bitand_expr");
        auto _single_result = parse_bitand_expr_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_tmp_18", _state, tell(), "bitand_expr");
            _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_19_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // bitxor_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_19", _state, tell(), "bitxor_expr");
        auto _single_result = parse_bitxor_expr_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_tmp_19", _state, tell(), "bitxor_expr");
            _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_20_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // shift_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_20", _state, tell(), "shift_expr");
        auto _single_result = parse_shift_expr_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_tmp_20", _state, tell(), "shift_expr");
            _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_21_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // unary_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_21", _state, tell(), "unary_expr");
        auto _single_result = parse_unary_expr_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_tmp_21", _state, tell(), "unary_expr");
            _res = std::move(_single_result);
    ...
    { // expr_5
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_21", _state, tell(), "expr_5");
        auto _single_result = parse_expr_5_rule();
        if (_single_result) {
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_tmp_21", _state, tell(), "expr_5");
            _res = std::move(_single_result);
...
// _loop1_22: STRING
std::optional<std::vector<lex::Token>> Parser::parse__loop1_22_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // STRING
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_22", _state, tell(), "STRING");
        while (true) {
...
std::optional<ast::sequence<ast::expr>> Parser::parse__loop0_24_rule()
{
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ',' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_24", _state, tell(), "',' expr");
        while (true) {
            auto _literal = lexer.expect().punct(lex::Punct::COMMA);
            if (_literal) {
...
std::optional<ast::sequence<ast::expr>> Parser::parse__gather_23_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // expr _loop0_24
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_gather_23", _state, tell(), "expr _loop0_24");
        auto _user_opt_expr_var = parse_expr_rule();
        if (_user_opt_expr_var) { auto expr_var = std::move(*_user_opt_expr_var);
        auto _user_opt_seq = parse__loop0_24_rule();
        if (_user_opt_seq) { auto seq = std::move(*_user_opt_seq);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_gather_23", _state, tell(), "expr _loop0_24");
            _res = std::move(seq);
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "expr _loop0_24");
            --_level;
            return _res;
        }
        }
...
std::optional<ast::sequence<ast::expr>> Parser::parse__loop0_26_rule()
{
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ',' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_26", _state, tell(), "',' expr");
        while (true) {
            auto _literal = lexer.expect().punct(lex::Punct::COMMA);
            if (_literal) {
            auto _user_opt_elem = parse_expr_rule();
...
std::optional<ast::sequence<ast::expr>> Parser::parse__gather_25_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::sequence<ast::expr>> _res = std::nullopt;
    { // expr _loop0_26
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_gather_25", _state, tell(), "expr _loop0_26");
        auto _user_opt_expr_var = parse_expr_rule();
        if (_user_opt_expr_var) { auto expr_var = std::move(*_user_opt_expr_var);
        auto _user_opt_seq = parse__loop0_26_rule();
        if (_user_opt_seq) { auto seq = std::move(*_user_opt_seq);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_gather_25", _state, tell(), "expr _loop0_26");
            _res = std::move(seq);
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "expr _loop0_26");
            --_level;
            return _res;
        }
        }
...
// _loop0_27: stmt
std::optional<ast::sequence<ast::stmt>> Parser::parse__loop0_27_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::stmt>> _children{};
    { // stmt
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_27", _state, tell(), "stmt");
        while (true) {
            auto _single_result = parse_stmt_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
// _tmp_28: ',' arg_spec
std::optional<ast::field<ast::arg_spec>> Parser::parse__tmp_28_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::arg_spec>> _res = std::nullopt;
    { // ',' arg_spec
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_28", _state, tell(), "',' arg_spec");
        auto _literal = lexer.expect().punct(lex::Punct::COMMA);
        if (_literal) {
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_29_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'and' expr_1
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_29", _state, tell(), "'and' expr_1");
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_30_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'or' expr_1
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_30", _state, tell(), "'or' expr_1");
