// AUTOGENERATED by bondrewd/tools/pegen++/pegenxx.py on 2023-04-03 16:52:01
// DO NOT EDIT
...
std::optional<ast::field<ast::args_spec>> Parser::parse_args_spec_rule()
{
    ...
    { // 
        ...
        PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "args_spec", _state, tell(), "");
        _res = ast::args_spec ( ast::make_sequence < ast::arg_def > ( ) );
        PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "");
        --_level;
        return _res;
        PARSER_DBG_("%*c- %s[%zu-%zu]: %s failed!\n", _level, ' ', "args_spec", _state, tell(), "");
...
std::optional<ast::field<ast::arg_spec>> Parser::parse_arg_spec_rule()
{
    ...
    { // name type_annotation [('=' expr)]
        ...
        auto _user_opt_d = parse__tmp_5_rule();
...
std::optional<ast::sequence < ast::stmt >> Parser::parse_defn_block_rule()
{
    ...
    { // '{' stmt* '}'
        ...
        if (_literal) {
        auto _user_opt_b = parse__loop0_6_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
...
// struct_def: 'struct' name? '(' args_spec ')'
std::optional<ast::field<ast::defn>> Parser::parse_struct_def_rule()
{
    ...
    (void)_state;
    std::optional<ast::field<ast::defn>> _res = std::nullopt;
    { // 'struct' name? '(' args_spec ')'
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "struct_def", _state, tell(), "'struct' name? '(' args_spec ')'");
        ...
        if (_literal_1) {
            ...
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "'struct' name? '(' args_spec ')'");
            --_level;
            return _res;
        }
        }
...
std::optional<ast::field<ast::flow>> Parser::parse_if_flow_rule()
{
    ...
    { // 'if' expr flow_block [('else' flow_block)]
        ...
        if (_user_opt_t) { auto t = std::move(*_user_opt_t);
        auto _user_opt_e = parse__tmp_7_rule();
...
std::optional<ast::field<ast::flow>> Parser::parse_for_flow_rule()
{
    ...
    { // 'for' name 'in' expr flow_block [('else' flow_block)]
        ...
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
        auto _user_opt_e = parse__tmp_8_rule();
        if (true) { auto e = _user_opt_e;
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "for_flow", _state, tell(), "'for' name 'in' expr flow_block [('else' flow_block)]");
...
std::optional<ast::field<ast::expr>> Parser::parse_disjunction_expr_rule()
{
    ...
    { // conjunction_expr (('or' conjunction_expr))+
        ...
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _user_opt_b = parse__loop1_10_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "disjunction_expr", _state, tell(), "conjunction_expr (('or' conjunction_expr))+");
...
std::optional<ast::field<ast::expr>> Parser::parse_conjunction_expr_rule()
{
    ...
    { // inversion_expr (('and' inversion_expr))+
        ...
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _user_opt_b = parse__loop1_11_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "conjunction_expr", _state, tell(), "inversion_expr (('and' inversion_expr))+");
...
std::optional<std::string> Parser::parse_strings_rule()
{
    ...
    { // STRING+
        ...
        auto _user_opt_a = parse__loop1_13_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "strings", _state, tell(), "STRING+");
...
std::optional<ast::field<ast::expr>> Parser::parse_tuple_expr_rule()
{
    ...
    { // '(' ','.expr+ ','? ')'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LPAR);
        if (_literal) {
        auto _user_opt_a = parse__gather_14_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _opt_var = lexer.expect().punct(lex::Punct::COMMA);
        if (true) { (void)_opt_var;
        auto _literal_1 = lexer.expect().punct(lex::Punct::RPAR);
...
std::optional<ast::field<ast::expr>> Parser::parse_array_expr_rule()
{
    ...
    { // '[' ','.expr+ ','? ']'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LSQB);
        if (_literal) {
        auto _user_opt_a = parse__gather_16_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _opt_var = lexer.expect().punct(lex::Punct::COMMA);
        if (true) { (void)_opt_var;
        auto _literal_1 = lexer.expect().punct(lex::Punct::RSQB);
...
std::optional<ast::field<ast::expr>> Parser::parse_block_expr_rule()
{
    ...
    { // 'ctime'? '{' stmt* expr_or_unit '}'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LBRACE);
        if (_literal) {
        auto _user_opt_b = parse__loop0_18_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
...
// _tmp_5: '=' expr
std::optional<ast::field<ast::expr>> Parser::parse__tmp_5_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // '=' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_5", _state, tell(), "'=' expr");
        auto _literal = lexer.expect().punct(lex::Punct::EQUAL);
        if (_literal) {
        auto _single_result = parse_expr_rule();
        if (_single_result) {
...
// _loop0_6: stmt
std::optional<ast::sequence<ast::stmt>> Parser::parse__loop0_6_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::stmt>> _children{};
    { // stmt
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_6", _state, tell(), "stmt");
        while (true) {
            auto _single_result = parse_stmt_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_7_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'else' flow_block
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_7", _state, tell(), "'else' flow_block");
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_8_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'else' flow_block
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_8", _state, tell(), "'else' flow_block");
        auto _keyword = lexer.expect().keyword(lex::HardKeyword::ELSE);
        if (_keyword) {
        auto _single_result = parse_flow_block_rule();
        if (_single_result) {
...
// _loop1_10: ('or' conjunction_expr)
std::optional<ast::sequence<ast::expr>> Parser::parse__loop1_10_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // ('or' conjunction_expr)
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_10", _state, tell(), "('or' conjunction_expr)");
        while (true) {
            auto _single_result = parse__tmp_19_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
// _loop1_11: ('and' inversion_expr)
std::optional<ast::sequence<ast::expr>> Parser::parse__loop1_11_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ('and' inversion_expr)
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_11", _state, tell(), "('and' inversion_expr)");
        while (true) {
            auto _single_result = parse__tmp_20_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
// _loop1_12: comparison_followup_pair
std::optional<std::vector<std::pair < ast::field < ast::cmp_op > , ast::field < ast::expr >>>> Parser::parse__loop1_12_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // comparison_followup_pair
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_12", _state, tell(), "comparison_followup_pair");
        while (true) {
...
// _loop1_13: STRING
std::optional<std::vector<lex::Token>> Parser::parse__loop1_13_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // STRING
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_13", _state, tell(), "STRING");
        while (true) {
...
// _loop0_15: ',' expr
std::optional<ast::sequence<ast::expr>> Parser::parse__loop0_15_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ',' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_15", _state, tell(), "',' expr");
        while (true) {
            auto _literal = lexer.expect().punct(lex::Punct::COMMA);
            if (_literal) {
...
// _gather_14: expr _loop0_15
std::optional<ast::sequence<ast::expr>> Parser::parse__gather_14_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // expr _loop0_15
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_gather_14", _state, tell(), "expr _loop0_15");
        auto _user_opt_expr_var = parse_expr_rule();
        if (_user_opt_expr_var) { auto expr_var = std::move(*_user_opt_expr_var);
        auto _user_opt_seq = parse__loop0_15_rule();
        if (_user_opt_seq) { auto seq = std::move(*_user_opt_seq);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_gather_14", _state, tell(), "expr _loop0_15");
            _res = std::move(seq);
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "expr _loop0_15");
            --_level;
            return _res;
        }
        }
...
// _loop0_17: ',' expr
std::optional<ast::sequence<ast::expr>> Parser::parse__loop0_17_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ',' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_17", _state, tell(), "',' expr");
        while (true) {
            auto _literal = lexer.expect().punct(lex::Punct::COMMA);
            if (_literal) {
            auto _user_opt_elem = parse_expr_rule();
...
// _gather_16: expr _loop0_17
std::optional<ast::sequence<ast::expr>> Parser::parse__gather_16_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::sequence<ast::expr>> _res = std::nullopt;
    { // expr _loop0_17
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_gather_16", _state, tell(), "expr _loop0_17");
        auto _user_opt_expr_var = parse_expr_rule();
        if (_user_opt_expr_var) { auto expr_var = std::move(*_user_opt_expr_var);
        auto _user_opt_seq = parse__loop0_17_rule();
        if (_user_opt_seq) { auto seq = std::move(*_user_opt_seq);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_gather_16", _state, tell(), "expr _loop0_17");
            _res = std::move(seq);
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "expr _loop0_17");
            --_level;
            return _res;
        }
        }
...
// _loop0_18: stmt
std::optional<ast::sequence<ast::stmt>> Parser::parse__loop0_18_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::stmt>> _children{};
    { // stmt
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_18", _state, tell(), "stmt");
        while (true) {
            auto _single_result = parse_stmt_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_19_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'or' conjunction_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_19", _state, tell(), "'or' conjunction_expr");
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_20_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'and' inversion_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_20", _state, tell(), "'and' inversion_expr");
