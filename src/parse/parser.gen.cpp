// AUTOGENERATED by bondrewd/tools/pegen++/pegenxx.py on 2023-04-03 17:43:36
// DO NOT EDIT
...
std::optional<std::string> Parser::parse_strings_rule()
{
    ...
    { // STRING+
        ...
        auto _user_opt_a = parse__loop1_16_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "strings", _state, tell(), "STRING+");
...
std::optional<ast::field<ast::expr>> Parser::parse_tuple_expr_rule()
{
    ...
    { // '(' ','.expr+ ','? ')'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LPAR);
        if (_literal) {
        auto _user_opt_a = parse__gather_17_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _opt_var = lexer.expect().punct(lex::Punct::COMMA);
        if (true) { (void)_opt_var;
        auto _literal_1 = lexer.expect().punct(lex::Punct::RPAR);
...
std::optional<ast::field<ast::expr>> Parser::parse_array_expr_rule()
{
    ...
    { // '[' ','.expr+ ','? ']'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LSQB);
        if (_literal) {
        auto _user_opt_a = parse__gather_19_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _opt_var = lexer.expect().punct(lex::Punct::COMMA);
        if (true) { (void)_opt_var;
        auto _literal_1 = lexer.expect().punct(lex::Punct::RSQB);
...
std::optional<ast::field<ast::expr>> Parser::parse_block_expr_rule()
{
    ...
    { // 'ctime'? '{' stmt* expr_or_unit '}'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LBRACE);
        if (_literal) {
        auto _user_opt_b = parse__loop0_21_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
...
std::optional<ast::sequence<ast::expr>> Parser::parse__loop1_13_rule()
{
    ...
    { // ('or' conjunction_expr)
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_13", _state, tell(), "('or' conjunction_expr)");
        while (true) {
            auto _single_result = parse__tmp_22_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
std::optional<ast::sequence<ast::expr>> Parser::parse__loop1_14_rule()
{
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ('and' inversion_expr)
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_14", _state, tell(), "('and' inversion_expr)");
        while (true) {
            auto _single_result = parse__tmp_23_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
// _loop1_16: STRING
std::optional<std::vector<lex::Token>> Parser::parse__loop1_16_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // STRING
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_16", _state, tell(), "STRING");
        while (true) {
...
// _loop0_18: ',' expr
std::optional<ast::sequence<ast::expr>> Parser::parse__loop0_18_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ',' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_18", _state, tell(), "',' expr");
        while (true) {
            auto _literal = lexer.expect().punct(lex::Punct::COMMA);
            if (_literal) {
...
// _gather_17: expr _loop0_18
std::optional<ast::sequence<ast::expr>> Parser::parse__gather_17_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // expr _loop0_18
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_gather_17", _state, tell(), "expr _loop0_18");
        auto _user_opt_expr_var = parse_expr_rule();
        if (_user_opt_expr_var) { auto expr_var = std::move(*_user_opt_expr_var);
        auto _user_opt_seq = parse__loop0_18_rule();
        if (_user_opt_seq) { auto seq = std::move(*_user_opt_seq);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_gather_17", _state, tell(), "expr _loop0_18");
            _res = std::move(seq);
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "expr _loop0_18");
            --_level;
            return _res;
        }
        }
...
// _loop0_20: ',' expr
std::optional<ast::sequence<ast::expr>> Parser::parse__loop0_20_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ',' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_20", _state, tell(), "',' expr");
        while (true) {
            auto _literal = lexer.expect().punct(lex::Punct::COMMA);
            if (_literal) {
            auto _user_opt_elem = parse_expr_rule();
...
// _gather_19: expr _loop0_20
std::optional<ast::sequence<ast::expr>> Parser::parse__gather_19_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::sequence<ast::expr>> _res = std::nullopt;
    { // expr _loop0_20
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_gather_19", _state, tell(), "expr _loop0_20");
        auto _user_opt_expr_var = parse_expr_rule();
        if (_user_opt_expr_var) { auto expr_var = std::move(*_user_opt_expr_var);
        auto _user_opt_seq = parse__loop0_20_rule();
        if (_user_opt_seq) { auto seq = std::move(*_user_opt_seq);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_gather_19", _state, tell(), "expr _loop0_20");
            _res = std::move(seq);
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "expr _loop0_20");
            --_level;
            return _res;
        }
        }
...
// _loop0_21: stmt
std::optional<ast::sequence<ast::stmt>> Parser::parse__loop0_21_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::stmt>> _children{};
    { // stmt
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_21", _state, tell(), "stmt");
        while (true) {
            auto _single_result = parse_stmt_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_22_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'or' conjunction_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_22", _state, tell(), "'or' conjunction_expr");
...
std::optional<ast::field<ast::expr>> Parser::parse__tmp_23_rule()
{
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'and' inversion_expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_23", _state, tell(), "'and' inversion_expr");
