// AUTOGENERATED by bondrewd/tools/pegen++/pegenxx.py on 2023-04-15 20:14:04
// DO NOT EDIT
...
// ns_spec_raw: '::'.name+
std::optional<ast::sequence < identifier >> Parser::parse_ns_spec_raw_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    const auto _state = tell();
    (void)_state;
    std::optional<ast::sequence < identifier >> _res = std::nullopt;
    { // '::'.name+
...
std::optional<std::string> Parser::parse_strings_rule()
{
    ...
    { // STRING+
        ...
        auto _user_opt_a = parse__loop1_24_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "strings", _state, tell(), "STRING+");
...
std::optional<ast::field<ast::expr>> Parser::parse_array_expr_rule()
{
    ...
    { // '[' ','.expr+ ','? ']'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LSQB);
        if (_literal) {
        auto _user_opt_a = parse__gather_27_rule();
        if (_user_opt_a) { auto a = std::move(*_user_opt_a);
        auto _opt_var = lexer.expect().punct(lex::Punct::COMMA);
        if (true) { (void)_opt_var;
        auto _literal_1 = lexer.expect().punct(lex::Punct::RSQB);
...
std::optional<ast::field<ast::expr>> Parser::parse_block_expr_rule()
{
    ...
    { // '{' stmt* expr_or_unit '}'
        ...
        auto _literal = lexer.expect().punct(lex::Punct::LBRACE);
        if (_literal) {
        auto _user_opt_b = parse__loop0_29_rule();
        if (_user_opt_b) { auto b = std::move(*_user_opt_b);
...
std::optional<ast::sequence<ast::expr>> Parser::parse__loop1_14_rule()
{
    ...
    { // ('and' expr_1)
        ...
        while (true) {
            auto _single_result = parse__tmp_31_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
std::optional<ast::sequence<ast::expr>> Parser::parse__loop1_15_rule()
{
    ...
    { // ('or' expr_1)
        ...
        while (true) {
            auto _single_result = parse__tmp_32_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
// _loop1_24: STRING
std::optional<std::vector<lex::Token>> Parser::parse__loop1_24_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    { // STRING
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop1_24", _state, tell(), "STRING");
        while (true) {
...
// _loop0_28: ',' expr
std::optional<ast::sequence<ast::expr>> Parser::parse__loop0_28_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::expr>> _children{};
    { // ',' expr
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_28", _state, tell(), "',' expr");
        while (true) {
            auto _literal = lexer.expect().punct(lex::Punct::COMMA);
            if (_literal) {
            auto _user_opt_elem = parse_expr_rule();
...
// _gather_27: expr _loop0_28
std::optional<ast::sequence<ast::expr>> Parser::parse__gather_27_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::sequence<ast::expr>> _res = std::nullopt;
    { // expr _loop0_28
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_gather_27", _state, tell(), "expr _loop0_28");
        auto _user_opt_expr_var = parse_expr_rule();
        if (_user_opt_expr_var) { auto expr_var = std::move(*_user_opt_expr_var);
        auto _user_opt_seq = parse__loop0_28_rule();
        if (_user_opt_seq) { auto seq = std::move(*_user_opt_seq);
            PARSER_DBG_("%*c+ %s[%zu-%zu]: %s succeeded!\n", _level, ' ', "_gather_27", _state, tell(), "expr _loop0_28");
            _res = std::move(seq);
            PARSER_DBG_("Hit with action [%zu-%zu]: %s\n", _state, tell(), "expr _loop0_28");
            --_level;
            return _res;
        }
        }
...
// _loop0_29: stmt
std::optional<ast::sequence<ast::stmt>> Parser::parse__loop0_29_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::vector<ast::field<ast::stmt>> _children{};
    { // stmt
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_loop0_29", _state, tell(), "stmt");
        while (true) {
            auto _single_result = parse_stmt_rule();
            if (_single_result) {
                _res = std::move(_single_result);
...
// _tmp_30: ',' arg_spec
std::optional<ast::field<ast::arg_spec>> Parser::parse__tmp_30_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::arg_spec>> _res = std::nullopt;
    { // ',' arg_spec
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_30", _state, tell(), "',' arg_spec");
        auto _literal = lexer.expect().punct(lex::Punct::COMMA);
        if (_literal) {
...
// _tmp_31: 'and' expr_1
std::optional<ast::field<ast::expr>> Parser::parse__tmp_31_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'and' expr_1
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_31", _state, tell(), "'and' expr_1");
...
// _tmp_32: 'or' expr_1
std::optional<ast::field<ast::expr>> Parser::parse__tmp_32_rule()
{
    if (++_level > MAX_RECURSION_LEVEL) {
        throw SyntaxError("Recursion limit exceeded");
    }
    ...
    std::optional<ast::field<ast::expr>> _res = std::nullopt;
    { // 'or' expr_1
        PARSER_DBG_("%*c> %s[%zu-%zu]: %s\n", _level, ' ', "_tmp_32", _state, tell(), "'or' expr_1");
